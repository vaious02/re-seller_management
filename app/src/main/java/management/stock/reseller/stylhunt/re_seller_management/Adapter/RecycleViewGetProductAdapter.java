...
import management.stock.reseller.stylhunt.re_seller_management.DataModel.Stock_Model;
 ...
 */
public class RecycleViewGetProductAdapter extends RecyclerView.Adapter<RecycleViewGetProductAdapter.RecyclerViewHolders> {
    ...
    public RecycleViewGetProductAdapter(Context context, ArrayList<GetProduct_Model> list, DatabaseReference rootRef) {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.hasChildren()){
                    price = Double.parseDouble(dataSnapshot.child("product_price").getValue(String.class));
